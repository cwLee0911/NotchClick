...
enum L10n {
    enum Key: String {
        case launcher, music, system, center
    ...
    private static let table: [AppLanguage: [Key: String]] = [
        .english: [
            .launcher: "Launcher", .music: "Music", .system: "System", .center: "Center",
            ...
            .aboutDescription: "A beautiful notch panel for macOS.\nApp launcher, Apple Music, Spotify, system status, and more.",
        ...
        .korean: [
            .launcher: "런처", .music: "음악", .system: "시스템", .center: "센터",
            ...
            .aboutDescription: "macOS를 위한 아름다운 노치 패널.\n앱 런처, Apple Music, Spotify, 시스템 상태 등을 제공합니다.",
        ...
        .chinese: [
            .launcher: "启动器", .music: "音乐", .system: "系统", .center: "中心",
            ...
            .aboutDescription: "适用于 macOS 的精美刘海面板。\n包含应用启动器、Apple Music、Spotify、系统状态等功能。",
        ...
        .japanese: [
            .launcher: "ランチャー", .music: "音楽", .system: "システム", .center: "センター",
            ...
            .aboutDescription: "macOS のための美しいノッチパネル。\nアプリランチャー、Apple Music、Spotify、システム状態などに対応。",
