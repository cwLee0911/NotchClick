...
enum L10n {
    ...
    private static let table: [AppLanguage: [Key: String]] = [
        .english: [
            ...
            .setMusicApp: "Set your music app in Center",
            .chooseMusicApp: "Choose Apple Music or Spotify in Center, then this screen will switch to that player automatically.",
        ...
        .korean: [
            ...
            .setMusicApp: "센터에서 음악 앱을 설정하세요",
            .chooseMusicApp: "센터에서 Apple Music 또는 Spotify를 선택하면 이 화면이 자동으로 해당 플레이어로 바뀝니다.",
        ...
        .chinese: [
            ...
            .setMusicApp: "在中心设置音乐应用",
            .chooseMusicApp: "在中心选择 Apple Music 或 Spotify 后，此页面会自动切换到对应播放器。",
        ...
        .japanese: [
            ...
            .setMusicApp: "センターで音楽アプリを設定",
            .chooseMusicApp: "センターで Apple Music または Spotify を選ぶと、この画面が自動で切り替わります。",
